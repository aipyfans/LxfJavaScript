...
var result = xiaoming.constructor === Student.prototype.constructor; // true
console.log(result);

var result = Student.prototype.constructor === Student; // true
console.log(result);

var result = Object.getPrototypeOf(xiaoming) === Student.prototype; // true
console.log(result);

var result = xiaoming instanceof Student; // true
console.log(result);
